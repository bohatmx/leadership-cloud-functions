...
exports.newReminderIn = functions.database
  .ref("/pldpNotifications/{notificationID}")
  .onCreate((snapshot, context) => {
    ...
    if (journalUserID == undefined || journalUserID == null) {
      console.log("Undefined journal user id: ", reminderObj);
      return false;
    }
    ...
    let user = admin
      ...
      .then(snap => {
        ...
        admin
          .database()
          .ref("pldpNotifications/" + notificationID + "/photoURL")
          .set(photoURL);
      })
      .catch(err => {
