...
module.exports = function () {
  this.htmlEmail = function (user, url) {
    ...
    // Harmony Welcome Email
      ...
      msg = '<b>Dear ' + firstName + ',</b><br><br>'
      msg += '<b>You have been nominated</b><br><br>'
      msg += 'We have launched the Global Leadership Platform App inside Harmony – your log in details are below. The App will be used for several purposes:<br><br>'
      msg += '<ol>'
      msg += '<li>More effective communication from my office, to expedite strategy execution, strengthen culture, improve adherence to values and much more. Every employee will receive notifications on their phone/App/laptop when I send a message. Analytics will give me the ability to see who read it and who didn’t. You will be able to comment on my communications. Please do. My messages will land under the “Organisational” function on the App menu.</li><br>'
      msg += '<li>This platform will create leadership fitness in our organisation. If you engage it on a regular basis you will become a better leader and human being. You, our organisation and society will benefit from this.</li><br>'
      msg += '<li>Please make use of the Personal Leadership Development Plan (PLDP) that you can access from anywhere on the App. On it is an explanatory video from Adriaan Groenewald, one of the co-founders of this platform.</li><br>'
      ...
      msg += '<li>This GLP is a product that we are taking to market, so please be aware that our use of it also serves as a live pilot, while we benefit as an organisation and individuals.</li><br><br>'
      msg += '</ol>'
      msg += 'You will discover much more about our company Global Leadership Platform as you use it. And, this will be a growing, changing platform with new and dynamic features in the pipeline.<br><br>'
      msg += '<b>Overall Course Objectives</b><br><br>'
      msg += 'To be a Harmony Ambassador and live the Harmony Brand <br><br>'
      msg += '<ol>'
      msg += '<li>Take accountability for safe delivery of results </li><br>'
      msg += '<li>Are versatile, open minded and effectively respond to change</li><br>'
      msg += '<li>Inspire and grow the leaders of tomorrow</li><br>'
      msg += '<li>Relate to and connect with others; and</li><br>'
      msg += '<li>Lead by example.</li><br>'
      msg += '</ol>'
      msg += '<br><br>'
      msg += '<b>Module Objectives </b><br><br>'
      msg += 'By the end of this session, delegates will: <br><br>'
      msg += '<ol>'
      msg += '<li>Understand the ‘self’ in the context of Harmony Business</li><br>'
      msg += '<li>Be equipped twith personal tools to deliver on Harmony Vision and Values.</li><br>'
      msg += '<li>Empowered  to give and receive feedback.</li><br>'
      msg += '<li>Equipped with skills to be  multipliers of talent to achieve Harmony goals.</li><br>'
      msg += '<li>Make personal commitments to become Harmony Ambassadors </li><br>'
      msg += '</ol>'
      msg += '<br><br>'
      msg += '<b>Competencies addressed</b><br><br>'
      msg += '<ol>'
      msg += '<li>Knowing self</li><br>'
      msg += '<li>Self-driven and conscientious</li><br>'
      msg += '<li>Adaptability</li><br>'
      msg += '<li>Mindful decision making</li><br>'
      msg += '<li>Accountability</li><br>'
      msg += '</ol>'
      msg += '<br><br>'
      msg += '<b>Resources</b><br><br>'
      msg += '<ol>'
      msg += '<li>Pre-reading</li><br>'
      msg += '<li>Pre – assessment</li><br>'
      msg += '<li>During programme</li><br>'
      msg += '<li>Post programme</li><br>'
      msg += '</ol>'
      msg += '<br><br>'
      msg += 'Please find below your Login Credentials and Link to the App: <br><br>'
      msg += 'App Link: ' + url + ' <br>'
